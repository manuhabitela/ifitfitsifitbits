<select name="timezone">
    <option value="UTC">--Please select your time zone--</option>
    ...
    <option value="Africa/Dar_es_Salaam">Africa/Dar es_Salaam</option>
    ...
    <option value="America/North_Dakota/New_Salem">America/North Dakota/New_Salem</option>
    ...
    <option value="America/Port_of_Spain">America/Port of_Spain</option>
    ...
    <option value="Asia/Ho_Chi_Minh">Asia/Ho Chi_Minh</option>
    ...
    <option value="Europe/Isle_of_Man">Europe/Isle of_Man</option>
    ...
    <option value="US/Pacific">US/Pacific</option></select>
